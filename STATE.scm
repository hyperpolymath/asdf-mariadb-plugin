...
;; STATE.scm - Project state tracking for asdf-mariadb-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-mariadb-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-mariadb-plugin")
    (repo "hyperpolymath/asdf-mariadb-plugin"))

  (project-context
    (name "asdf-mariadb-plugin")
